...
void Vertex::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *){
    ...
    if (option->state & QStyle::State_Sunken) {
        ...
        if (this -> color == "white"){
            ...
            gradient.setColorAt(1, QColor("orange").lighter(120));
            gradient.setColorAt(0, QColor("darkorange").lighter(120));
        }
        ...
        if (this -> color == "white"){
            ...
            gradient.setColorAt(0, QColor("orange").lighter(120));
            gradient.setColorAt(1, QColor("darkorange").lighter(120));
        }
        else if (this -> color == "red"){
            gradient.setColorAt(1, QColor(Qt::red).lighter(120));
            gradient.setColorAt(0, QColor(Qt::red).lighter(120));
